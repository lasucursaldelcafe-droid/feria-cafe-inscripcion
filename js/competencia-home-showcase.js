...
(function (global) {
  ...
  function fallbackFromPreliminar1() {
    ...
    return {
      ...
      subtitulo: kit.event && kit.event.nombre ? kit.event.nombre : 'Preliminar 1',
      descripcion: '12 baristas en duelos 1v1. Podio oficial de la primera preliminar del circuito.',
      badge: 'Reto V60',
      mostrarPodio: true,
